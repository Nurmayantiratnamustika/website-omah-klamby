...
<p class="outline">Sepatu</p><br>
<div class="slideshow-container">
  <div class="mySlides fade">
    <div class="numbertext">1 / 3</div>
    <img src="img/gambar24.jpg" style="width:100%">
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="img/gambar22.jpg" style="width:100%">
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="img/gambar23.jpg" style="width:100%">
  </div>
<br>
...
<?php
// Load file koneksi.php
$query = "SELECT * FROM barang where id_barang between '17' and '24' order by id_barang desc";
