...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="popular2.css">
...
<p class="outline">Popular</p><br>

<div class="popular">
<a target="_blank" href="popular.php">
  <p>#OMAHKLAMBY POPULAR ITEM <br>
  Temukan koleksi menarik di Omah Klamby</p></a>
</div>
        

    
<div class="popularlagi">
<a target="_blank" href="pakaian.php">
  <p>#SPRINGDAY <br>
  Nikmati suasana musim panas dengan koleksi dari <i>Omah Klamby</i> bulan ini !</p></a>
</div>
...
<?php
// Load file koneksi.php
$query = "SELECT * FROM barang where id_barang between '25' and '32' order by id_barang desc";
