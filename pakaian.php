...
<div class="navbar">
 <ul>
  ...
  <li><a class="activ e" href="#">Category</a>
  <ul>
...
<p class="outline">Pakaian</p><br>
<div class="slideshow-container">
  <div class="mySlides fade">
    <div class="numbertext">1 / 3</div>
    <img src="img/minggu13.jpg" style="width:100%">
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="img/gambar14.jpg" style="width:100%">
  </div>
...
$query = "SELECT * FROM barang where id_barang between '1' and '8' order by id_barang desc";
...
<div><a href="beli.php?id=<?php echo $data['id_barang'];?>" class="button" style="vertical-align:middle"><span>Buy</a></span></div>
    </div>
    </div>
    <?php
  }
